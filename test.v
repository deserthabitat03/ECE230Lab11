...
module test();
    ...
    initial begin
        ...
        //Test 2: After additional 1 clock cycle, check if the ripple counter resets after counting down from 7 to 0
        for (i = 0; i < 2; i = i + 1) begin
            #1 clk = ~clk;
        end
        #5;
        // We should have toggled the /8 ripple counter
        if (rc_state[2] !== 1'b0) begin
            fail = 1;
            $display("Test 2: Failed to toggle final bit of the ripple counter output off");
        end
